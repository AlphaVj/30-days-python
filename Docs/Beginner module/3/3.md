[02 ⇦ Previous](/Docs/Beginner%20module/2/2.md) || [Next ⇨ 04](/Docs/Beginner%20module/4/4.md) || [01 🚩](/readme.md)
...
![operator precedence](/images/operator%20precedence.png)


By understanding and using operator precedence and parentheses effectively, you can write Python code that is both correct and easy to read.

### [Associativity](#03---operators)
...
### [Left-Associative Operators:](#03---operators)
...
### [Right-Associative Operators:](#03---operators)
...
### [Non-Associative Operators:](#03---operators)
